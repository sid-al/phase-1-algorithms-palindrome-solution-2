...
> letter**, and the **second letter** is the same as the **second to last** letter, 
  and so on (until the middle of the word), the function should return
  `true`.

  iterate from the begginig to the middle
    check each letter to the corresponding letter from the end
      if any letters dont match up
        return false;
      if they much up;
        return true;
